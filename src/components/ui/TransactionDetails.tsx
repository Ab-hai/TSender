...
const DetailRow = ({ label, value }: DetailRowProps) => (
    <div className="flex justify-between items-center mt-2">
        <p className="text-sm placeholder:text-zinc-500 dark:placeholder:text-zinc-400 text-zinc-800 dark:text-zinc-300">
            {label}
        </p>
        <p className="text-sm placeholder:text-zinc-500 dark:placeholder:text-zinc-400 text-zinc-800 dark:text-zinc-300 font-semibold">
            {value}
        </p>
    </div>
)
